...
class CommunicationAwareSA(SA):
    ...
    def aggregate_fit(self, server_round: int, results: List[Tuple[flwr.server.client_proxy.ClientProxy, FitRes]],
        ...
        if server_round == 10: # Adjust based on your total rounds
            ...
            try:
                METRICS_BASE = r"D:\T24\MAFL\IDS-FL-CSE400-FINAL_Manuscript Phase - Copy\client_metrics" 
                RESULTS_BASE = r"D:\T24\MAFL\IDS-FL-CSE400-FINAL_Manuscript Phase - Copy\results"
                ...
                plot_and_save_energy_temp(r"D:\T24\MAFL\IDS-FL-CSE400-FINAL_Manuscript Phase - Copy\client_sa_metrics" , r"D:\T24\MAFL\IDS-FL-CSE400-FINAL_Manuscript Phase - Copy\results")
